...
const PostSchema = new Schema({
    ...
    // we want to keep all the posts even after the user who created them has
    ...
    // The structure of comments is the same as posts except that comments don't have likes.
    comments: [
        {
            user: {
                type: Schema.Types.ObjectId,
